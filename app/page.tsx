...
import { Activity, AlertTriangle, ArrowDownRight, ArrowUpRight, BarChart3, Bell, Bot, Check, ChevronDown, CircleHelp, CreditCard, Download, Edit3, LayoutDashboard, LineChart, Menu, MoreHorizontal, Moon, Pause, Pencil, Play, Plus, Search, Server, Settings, ShieldCheck, Sparkles, Sun, Trash2, TrendingUp, Users, Wallet, X, Zap } from 'lucide-react'
...
type Robot = { id: string; name: string; strategy: string; status: 'Running' | 'Paused' | 'Stopped'; accountId: string; vpsId: string | null; orders: number; execution: number; risk: string }
